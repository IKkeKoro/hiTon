...
function dictValueParserTokenMaster$Data(): DictionaryValue<TokenMaster$Data> {
 ...
 type MembersPool_init_args = {
    $$type: 'MembersPool_init_args';
    master: Address;
}

function initMembersPool_init_args(src: MembersPool_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.master);
    };
...
async function MembersPool_init(master: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initMembersPool_init_args({ $$type: 'MembersPool_init_args', master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const MembersPool_errors: { [key: number]: { message: string } } = {
...
const MembersPool_types: ABIType[] = [
...
const MembersPool_getters: ABIGetter[] = [
    {"name":"poolData","arguments":[],"returnType":{"kind":"simple","type":"PoolData","optional":false}},
]

export const MembersPool_getterMapping: { [key: string]: string } = {
    'poolData': 'getPoolData',
}

const MembersPool_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"AddIncome"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SendIncome"}},
]

export class MembersPool implements Contract {
    
    static async init(master: Address) {
        return await MembersPool_init(master);
    }
    
    static async fromInit(master: Address) {
        const init = await MembersPool_init(master);
        const address = contractAddress(0, init);
        return new MembersPool(address, init);
    }
    
    static fromAddress(address: Address) {
        return new MembersPool(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  MembersPool_types,
        getters: MembersPool_getters,
        receivers: MembersPool_receivers,
        errors: MembersPool_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: AddIncome | SendIncome) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SendIncome') {
            body = beginCell().store(storeSendIncome(message)).endCell();
        }
    ...
    async getPoolData(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('poolData', builder.build())).stack;
